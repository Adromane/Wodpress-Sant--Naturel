...
return array(
    ...
    <p class="has-text-align-center small-text has-primary-color has-background-background-color has-text-color has-background has-link-color has-lato-font-family has-tiny-font-size" style="font-style:normal;font-weight:700">'. esc_html('Wedding Event','event-management-blocks').'</p>
    <!-- /wp:paragraph -->
    ...
    <h1 class="wp-block-heading banner-heading has-background-color has-text-color has-link-color has-lato-font-family" style="font-size:40px;font-style:normal;font-weight:700">'. esc_html('The Honor Of Your Presence Is Requested.','event-management-blocks').'</h1>
    <!-- /wp:heading -->
    ...
    <p class="has-background-color has-text-color has-link-color has-lato-font-family has-medium-font-size" style="font-style:normal;font-weight:700;line-height:1.1">'. esc_html('Virtual Event','event-management-blocks').'</p>
    <!-- /wp:paragraph -->
    ...
    <p class="has-background-color has-text-color has-link-color has-lato-font-family has-tiny-font-size" style="font-style:normal;font-weight:400;line-height:1.1">'. esc_html('Lorem ipsum dolor sit amet, consectetur','event-management-blocks').'</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:column --></div>
    <!-- /wp:columns --></div>
    <!-- /wp:group --></div>
    ...
    <div class="wp-block-columns"><!-- wp:column {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"default"}} -->
    <div class="wp-block-column"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"typography":{"lineHeight":"1.1","fontStyle":"normal","fontWeight":"700"}},"textColor":"background","fontSize":"medium","fontFamily":"lato"} -->
    <p class="has-background-color has-text-color has-link-color has-lato-font-family has-medium-font-size" style="font-style:normal;font-weight:700;line-height:1.1">'. esc_html('Conference','event-management-blocks').'</p>
    <!-- /wp:paragraph -->
    ...
    <p class="has-background-color has-text-color has-link-color has-lato-font-family has-medium-font-size" style="font-style:normal;font-weight:700;line-height:1.1">'. esc_html('Follow Us','event-management-blocks').'</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:column -->
