...
return array(
    ...
    <div class="wp-block-group service-group"><!-- wp:paragraph {"align":"center","className":"small-text","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"typography":{"fontStyle":"normal","fontWeight":"700"},"color":{"background":"#ec3892"},"spacing":{"padding":{"right":"var:preset|spacing|40","left":"var:preset|spacing|40"}}},"textColor":"background","fontSize":"extra-small","fontFamily":"lato"} -->
    <p class="has-text-align-center small-text has-background-color has-text-color has-background has-link-color has-lato-font-family has-extra-small-font-size" style="background-color:#ec3892;padding-right:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40);font-style:normal;font-weight:700">'. esc_html('Services','event-management-blocks').'</p>
    <!-- /wp:paragraph -->
    ...
    <h1 class="wp-block-heading has-primary-color has-text-color has-link-color has-lato-font-family" style="font-size:30px;font-style:normal;font-weight:700">'. esc_html('Events Management Services','event-management-blocks').'</h1>
    <!-- /wp:heading -->
    ...
    <p class="has-text-align-center service-number has-text-color has-link-color" style="color:#0000000d;font-size:60px;font-style:normal;font-weight:900">'. esc_html('01','event-management-blocks').'</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:column -->
    ...
    <h4 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-lato-font-family" style="font-size:20px;font-style:normal;font-weight:700">'. esc_html('Night Party Service','event-management-blocks').'</h4>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center","width":"15%"} -->
    <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:15%"><!-- wp:paragraph {"align":"center","className":"service-number","style":{"typography":{"fontSize":"60px","fontStyle":"normal","fontWeight":"900"},"elements":{"link":{"color":{"text":"#0000000d"}}},"color":{"text":"#0000000d"}}} -->
    <p class="has-text-align-center service-number has-text-color has-link-color" style="color:#0000000d;font-size:60px;font-style:normal;font-weight:900">'. esc_html('02','event-management-blocks').'</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:column -->
    ...
    <!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"20px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"lato"} -->
    <h4 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-lato-font-family" style="font-size:20px;font-style:normal;font-weight:700">'. esc_html('Wedding Party Service','event-management-blocks').'</h4>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center","width":"15%"} -->
    <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:15%"><!-- wp:paragraph {"align":"center","className":"service-number","style":{"typography":{"fontSize":"60px","fontStyle":"normal","fontWeight":"900"},"elements":{"link":{"color":{"text":"#0000000d"}}},"color":{"text":"#0000000d"}}} -->
    <p class="has-text-align-center service-number has-text-color has-link-color" style="color:#0000000d;font-size:60px;font-style:normal;font-weight:900">'. esc_html('03','event-management-blocks').'</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:column -->
    ...
    <!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"20px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"lato"} -->
    <h4 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-lato-font-family" style="font-size:20px;font-style:normal;font-weight:700">'. esc_html('Birthday Party Service','event-management-blocks').'</h4>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center","width":"15%"} -->
    <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:15%"><!-- wp:paragraph {"align":"center","className":"service-number","style":{"typography":{"fontSize":"60px","fontStyle":"normal","fontWeight":"900"},"elements":{"link":{"color":{"text":"#0000000d"}}},"color":{"text":"#0000000d"}}} -->
    <p class="has-text-align-center service-number has-text-color has-link-color" style="color:#0000000d;font-size:60px;font-style:normal;font-weight:900">'. esc_html('04','event-management-blocks').'</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:column -->
    ...
    <!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"20px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"lato"} -->
    <h4 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-lato-font-family" style="font-size:20px;font-style:normal;font-weight:700">'. esc_html('Baby Shower Service','event-management-blocks').'</h4>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center","width":"15%"} -->
    <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:15%"><!-- wp:paragraph {"align":"center","className":"service-number","style":{"typography":{"fontSize":"60px","fontStyle":"normal","fontWeight":"900"},"elements":{"link":{"color":{"text":"#0000000d"}}},"color":{"text":"#0000000d"}}} -->
    <p class="has-text-align-center service-number has-text-color has-link-color" style="color:#0000000d;font-size:60px;font-style:normal;font-weight:900">'. esc_html('05','event-management-blocks').'</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:column -->
    ...
    <!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"20px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"lato"} -->
    <h4 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-lato-font-family" style="font-size:20px;font-style:normal;font-weight:700">'. esc_html('Kitty Party','event-management-blocks').'</h4>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center","width":"15%"} -->
    <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:15%"><!-- wp:paragraph {"align":"center","className":"service-number","style":{"typography":{"fontSize":"60px","fontStyle":"normal","fontWeight":"900"},"elements":{"link":{"color":{"text":"#0000000d"}}},"color":{"text":"#0000000d"}}} -->
    <p class="has-text-align-center service-number has-text-color has-link-color" style="color:#0000000d;font-size:60px;font-style:normal;font-weight:900">'. esc_html('06','event-management-blocks').'</p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:column -->
    ...
    <!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"20px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"lato"} -->
    <h4 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-lato-font-family" style="font-size:20px;font-style:normal;font-weight:700">'. esc_html('Festival Party','event-management-blocks').'</h4>
    <!-- /wp:heading -->
