...
return array(
    ...
    <div class="wp-block-group has-background-color has-text-color has-background has-link-color" style="background-color:#101010"><!-- wp:columns {"className":"alignwide","style":{"spacing":{"padding":{"top":"35px","bottom":"35px","right":"0px","left":"0px"},"blockGap":{"top":"0","left":"0"},"margin":{"top":"0","bottom":"0"}}}} -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html('About Us','event-management-blocks') .'</h2>
        <!-- /wp:heading -->
        
        <!-- wp:paragraph {"fontSize":"medium","fontFamily":"lato"} -->
        <p class="has-lato-font-family has-medium-font-size">'. esc_html('Lorem Ipsum is simply dummy text of the printing and typesetting industry.','event-management-blocks') .'</p>
        <!-- /wp:paragraph -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html('Events','event-management-blocks') .'</h2>
        <!-- /wp:heading -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html('Helps','event-management-blocks') .'</h2>
        <!-- /wp:heading -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html('Contact Us','event-management-blocks') .'</h2>
        <!-- /wp:heading -->
        ...
        <p class="has-text-align-left has-background-color has-text-color has-link-color has-inter-font-family has-medium-font-size has-lato-font-family" style="font-style:normal;font-weight:400"><span class="dashicons dashicons-email-alt"></span> '. esc_html('support@example.com','event-management-blocks') .'</p>
        <!-- /wp:paragraph -->
        ...
        <p class="has-link-color has-inter-font-family has-background-color has-text-color has-lato-font-family has-medium-font-size" style="font-style:normal;font-weight:500"><span class="dashicons dashicons-phone"></span> '. esc_html('+123 456 7890','event-management-blocks') .'</p>
        <!-- /wp:paragraph -->
        ...
        <p class="has-background-color has-text-color has-link-color has-inter-font-family has-medium-font-size has-lato-font-family" style="font-style:normal;font-weight:500"><span class="dashicons dashicons-admin-home"></span> '. esc_html('123, Red Hills, Chicago,IL, USA','event-management-blocks') .'</p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:column --></div>
        <!-- /wp:columns --></div>
        <!-- /wp:group -->
        ...
        <p class="has-text-align-center has-background-color has-text-color has-link-color has-inter-font-family has-medium-font-size has-lato-font-family"><a href="https://www.wpradiant.net/">'. esc_html('WP Radiant','event-management-blocks') .'</a> |'. esc_html('Proudly powered by','event-management-blocks') .' <a href="https://wordpress.org/">  '. esc_html('WordPress','event-management-blocks') .'</a></p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:column --></div>
        <!-- /wp:columns --></div>
        <!-- /wp:group -->',
